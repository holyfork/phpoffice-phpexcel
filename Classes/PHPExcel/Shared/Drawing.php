...
class PHPExcel_Shared_Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pValue = 0, PHPExcel_Style_Font|null $pDefaultFont = null)
    {
        // Font name and size
     ...
     * @return     int        Value in pixels
     */
    public static function cellDimensionToPixels($pValue = 0, PHPExcel_Style_Font|null $pDefaultFont = null)
    {
        // Font name and size
        $name = $pDefaultFont ? $pDefaultFont->getName() : 'Calibri';
        $size = $pDefaultFont ? $pDefaultFont->getSize() : 11;

...
class PHPExcel_Shared_Font
{
     ...
     */
    public static function calculateColumnWidth(PHPExcel_Style_Font $font, $cellText = '', $rotation = 0, PHPExcel_Style_Font|null $defaultFont = null)
    {
...
//        $upperLeftCornerY  = $textBox[7];
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, PHPExcel_Style_Font|null $font = null, $rotation = 0)
    {

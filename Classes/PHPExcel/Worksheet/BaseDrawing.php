...
class PHPExcel_Worksheet_BaseDrawing implements PHPExcel_IComparable
{
     ...
     * @return PHPExcel_Worksheet_BaseDrawing
     */
    public function setWorksheet(PHPExcel_Worksheet|null $pValue = null, $pOverrideOld = false)
    {
     ...
     * @return PHPExcel_Worksheet_BaseDrawing
     */
    public function setShadow(PHPExcel_Worksheet_Drawing_Shadow|null $pValue = null)
    {
           $this->shadow = $pValue;
           return $this;
    }

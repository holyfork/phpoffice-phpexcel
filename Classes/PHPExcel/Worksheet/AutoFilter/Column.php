...
class PHPExcel_Worksheet_AutoFilter_Column
{
     ...
     */
    public function __construct($pColumn, PHPExcel_Worksheet_AutoFilter|null $pParent = null)
    {
     ...
     * @return PHPExcel_Worksheet_AutoFilter_Column
     */
    public function setParent(PHPExcel_Worksheet_AutoFilter|null $pParent = null)
    {
        $this->parent = $pParent;

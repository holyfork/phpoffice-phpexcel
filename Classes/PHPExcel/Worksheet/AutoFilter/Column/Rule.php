...
//    const AUTOFILTER_COLUMN_RULE_ALLDATESINQUARTER    = 'allDatesInQuarter';    //    <dynamicFilter type="Q2"/> for Quarter 2
     ...
     */
    public function __construct(PHPExcel_Worksheet_AutoFilter_Column|null $pParent = null)
    {
        $this->parent = $pParent;
    }
     ...
     * @return PHPExcel_Worksheet_AutoFilter_Column_Rule
     */
    public function setParent(PHPExcel_Worksheet_AutoFilter_Column|null $pParent = null)
    {
        $this->parent = $pParent;

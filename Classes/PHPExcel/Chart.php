...
class PHPExcel_Chart
{
     ...
     */
    public function __construct($name, PHPExcel_Chart_Title|null $title = null, PHPExcel_Chart_Legend|null $legend = null, PHPExcel_Chart_PlotArea|null $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', PHPExcel_Chart_Title|null $xAxisLabel = null, PHPExcel_Chart_Title|null $yAxisLabel = null, PHPExcel_Chart_Axis|null $xAxis = null, PHPExcel_Chart_Axis|null $yAxis = null, PHPExcel_Chart_GridLines|null $majorGridlines = null, PHPExcel_Chart_GridLines|null $minorGridlines = null)
    {
        $this->name = $name;
        $this->title = $title;
        $this->legend = $legend;
     ...
     */
    public function setWorksheet(PHPExcel_Worksheet|null $pValue = null)
    {

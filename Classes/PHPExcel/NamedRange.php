...
class PHPExcel_NamedRange
{
     ...
     */
    public function __construct($pName = null, PHPExcel_Worksheet|null $pWorksheet = null, $pRange = 'A1', $pLocalOnly = false, $pScope = null)
    {
        // Validate data
     ...
     * @return PHPExcel_NamedRange
     */
    public function setWorksheet(PHPExcel_Worksheet|null $value = null)
    {
        if ($value !== null) {
    ...
    public static function resolveRange($pNamedRange = '', PHPExcel_Worksheet|null $pSheet = null)
    {
        ...
        $parent = $pSheet->getParent();

        return $parent ? $parent->getNamedRange($pNamedRange, $pSheet) : null;
    }

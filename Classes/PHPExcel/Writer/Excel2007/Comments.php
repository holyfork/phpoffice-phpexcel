...
class PHPExcel_Writer_Excel2007_Comments extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeComments(PHPExcel_Worksheet|null $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeComment(PHPExcel_Shared_XMLWriter|null $objWriter = null, $pCellReference = 'A1', PHPExcel_Comment|null $pComment = null, $pAuthors = null)
    {
        // comment
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeVMLComments(PHPExcel_Worksheet|null $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeVMLComment(PHPExcel_Shared_XMLWriter|null $objWriter = null, $pCellReference = 'A1', PHPExcel_Comment|null $pComment = null)
    {
         // Metadata

...
class PHPExcel_Writer_Excel2007_Drawing extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeDrawings(PHPExcel_Worksheet|null $pWorksheet = null, &$chartRef, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeChart(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Chart|null $pChart = null, $pRelationId = -1)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeDrawing(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Worksheet_BaseDrawing|null $pDrawing = null, $pRelationId = -1)
    {
        if ($pRelationId >= 0) {
            // xdr:oneCellAnchor
...
*/
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeVMLHeaderFooterImages(PHPExcel_Worksheet|null $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeVMLHeaderFooterImage(PHPExcel_Shared_XMLWriter|null $objWriter = null, $pReference = '', PHPExcel_Worksheet_HeaderFooterDrawing|null $pImage = null)
    {
        // Calculate object id
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allDrawings(PHPExcel|null $pPHPExcel = null)
    {
        // Get an array of all drawings
        $aDrawings    = array();

...
class PHPExcel_Writer_Excel2007_ContentTypes extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeContentTypes(PHPExcel|null $pPHPExcel = null, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeDefaultContentType(PHPExcel_Shared_XMLWriter|null $objWriter = null, $pPartname = '', $pContentType = '')
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeOverrideContentType(PHPExcel_Shared_XMLWriter|null $objWriter = null, $pPartname = '', $pContentType = '')
    {
        if ($pPartname != '' && $pContentType != '') {
            // Write content type

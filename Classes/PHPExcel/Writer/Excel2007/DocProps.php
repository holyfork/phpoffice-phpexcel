...
class PHPExcel_Writer_Excel2007_DocProps extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeDocPropsApp(PHPExcel|null $pPHPExcel = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeDocPropsCore(PHPExcel|null $pPHPExcel = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeDocPropsCustom(PHPExcel|null $pPHPExcel = null)
    {

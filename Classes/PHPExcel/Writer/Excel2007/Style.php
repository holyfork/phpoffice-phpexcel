...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeStyles(PHPExcel|null $pPHPExcel = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeFill(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style_Fill|null $pFill = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeGradientFill(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style_Fill|null $pFill = null)
    {
        // fill
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writePatternFill(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style_Fill|null $pFill = null)
    {
        // fill
        $objWriter->startElement('fill');
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeFont(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style_Font|null $pFont = null)
    {
        // font
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeBorder(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style_Borders|null $pBorders = null)
    {
        // Write border
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeCellStyleXf(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style|null $pStyle = null, PHPExcel|null $pPHPExcel = null)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeCellStyleDxf(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style|null $pStyle = null)
    {
        // dxf
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeBorderPr(PHPExcel_Shared_XMLWriter|null $objWriter = null, $pName = 'left', PHPExcel_Style_Border|null $pBorder = null)
    {
        // Write BorderPr
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeNumFmt(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_Style_NumberFormat|null $pNumberFormat = null, $pId = 0)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allStyles(PHPExcel|null $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allConditionalStyles(PHPExcel|null $pPHPExcel = null)
    {
        // Get an array of all styles
        $aStyles = array();
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allFills(PHPExcel|null $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allFonts(PHPExcel|null $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allBorders(PHPExcel|null $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allNumberFormats(PHPExcel|null $pPHPExcel = null)
    {

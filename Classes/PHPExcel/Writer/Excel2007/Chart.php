...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeChart(PHPExcel_Chart|null $pChart = null, $calculateCellValues = true)
    {
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeTitle(PHPExcel_Chart_Title|null $title = null, $objWriter)
    {
        if (is_null($title)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLegend(PHPExcel_Chart_Legend|null $legend = null, $objWriter)
    {
        if (is_null($legend)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType = 'str', PHPExcel_Worksheet|null $pSheet = null)
    {
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLayout(PHPExcel_Chart_Layout|null $layout = null, $objWriter)
    {

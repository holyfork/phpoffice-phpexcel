...
class PHPExcel_Writer_Excel2007_StringTable extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeRichText(PHPExcel_Shared_XMLWriter|null $objWriter = null, PHPExcel_RichText|null $pRichText = null, $prefix = null)
    {
        if ($prefix !== null) {
            $prefix .= ':';
        }
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeRichTextForCharts(PHPExcel_Shared_XMLWriter|null $objWriter = null, $pRichText = null, $prefix = null)
    {

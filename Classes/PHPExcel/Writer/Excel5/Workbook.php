...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
     ...
     */
    public function __construct(PHPExcel|null $phpExcel = null, &$str_total, &$str_unique, &$str_table, &$colors, $parser)
    {
     ...
     */
    public function setEscher(PHPExcel_Shared_Escher|null $pValue = null)
    {
        $this->escher = $pValue;
    }
}
